      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Expanded(
                child: SingleChildScrollView(child: PrivacyNoticeBody()),
              ),
...
class PrivacyNoticeViewScreen extends StatelessWidget {
  const PrivacyNoticeViewScreen({super.key});
...
class PrivacyNoticeBody extends StatelessWidget {
  const PrivacyNoticeBody({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        const _SectionHeader(label: 'What this application does'),
        const Text(
        ...
        const SizedBox(height: 20),
        const _SectionHeader(label: 'Data we collect and why'),
        const _DataItem(
        ...
        const SizedBox(height: 20),
        const _SectionHeader(label: 'Data we do not collect'),
        const Text(
        ...
        const SizedBox(height: 20),
        const _SectionHeader(label: 'Your rights'),
        const Text(
        ...
        const SizedBox(height: 20),
        const _SectionHeader(label: 'Remote wipe'),
        const Text(
