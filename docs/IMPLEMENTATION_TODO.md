...
| 3.6 | §14.2 | In-app privacy notice at first launch | Client | Planned | Use text from Appendix E |
| 3.7 | §14.3 | EULA acceptance at first launch | Client | Planned | Use text from §14.3 |
